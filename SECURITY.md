...
If you find a security vulnerability in MRMU Validation Suite, please report it through [GitHub's private vulnerability reporting](https://github.com/ccsarmientot/validation-suite/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact ccsarmientot@gmail.com for details.
