...
- `src/validation_suite/` package with CLI (Typer + Rich), py.typed marker
...
[@ccsarmientot](https://github.com/ccsarmientot) (+Cristian C. Sarmiento) created MRMU Validation Suite.
